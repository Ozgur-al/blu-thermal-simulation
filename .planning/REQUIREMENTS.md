...
- [ ] **GUI-03**: User can run simulation with visible progress bar and cancel button
- [ ] **GUI-04**: Status bar shows file path, modified indicator, last run time, and solver state
